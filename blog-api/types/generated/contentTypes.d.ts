...
export interface ApiBlogNavigationBlogNavigation
  ...
  info: {
    description: '\u0645\u0646\u0648\u06CC \u0646\u0627\u0648\u0628\u0631\u06CC \u0648 \u0641\u06CC\u0644\u062A\u0631\u0647\u0627\u06CC \u0628\u0644\u0627\u06AF';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    filterMenuItems: Schema.Attribute.Component<'shared.menu-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mainMenuItems: Schema.Attribute.Component<'shared.menu-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
